...
const Category = () => {
  ...
  <Card.Header className='header-info d-flex justify-content-between p-3 mb-2'>
    <div className='movieTitle'> 
      ...
      <p>Schedule: {categorie.schedule?.time} - 
      {categorie.schedule?.days}
      </p>
    </div>
    <div className='movieTitle'>  
    {categorie.rating.average ?
      
      <i className='d-flex justify-content-center align-item-center gap-2'> <FaStar className='text-info fs-3'></FaStar><h6 className='fs-4'>{categorie.rating.average}</h6></i>
    :
...
<Card.Footer>
  <div className='d-flex justify-content-between'>
    <div>
     ...
     <h5>Schedule:{categorie.schedule?.days} at {categorie.schedule?.time} 
       </h5>
    ...
    <h5>Genres: {categorie.genres[0]} | {categorie.genres[1]}</h5>
